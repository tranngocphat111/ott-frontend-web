...
interface PhoneSuccessScreenProps {
  sessionsRevoked?: number;
}

const PhoneSuccessScreen: React.FC<PhoneSuccessScreenProps> = ({ sessionsRevoked }) => (
  <div style={{
    minHeight: '100vh',
    ...
    >
      ...
      <h2 style={{
        ...
        fontWeight: 700, color: 'var(--color-primary-900)', margin: '0 0 8px',
      }}>
        Thành công!
      </h2>
      <p style={{ fontSize: '0.9rem', color: 'var(--color-primary-600)', margin: 0, lineHeight: 1.6 }}>
        ...
        {sessionsRevoked != null && sessionsRevoked > 0 && (
          <><br /><span style={{ fontWeight: 600, color: 'var(--color-primary-700)' }}>{sessionsRevoked}</span> phiên đăng nhập khác đã bị hủy.</>
        )}
